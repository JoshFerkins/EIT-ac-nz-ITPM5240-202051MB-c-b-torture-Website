...
<p>This deployment of our application will be the alpha release of our application C&B Music. This release must be time and cost efficient and will help further development of the application and keep the application up to date. This alpha release stage will focus on user feedback and is mostly testing and making assessments with a small portion of users.</p>

<p>Our goals for this deployment are as follows:
